...
namespace STOCMA.Controllers
{
    ...
    */
    public class DgbFItemsController : ODataController
    {
        ...
        public BonAvoirCItemsController(ApplicationDbContext db)
        {
            this.db = db;
        }
        ...
        public async Task<IActionResult> Put([FromODataUri] Guid key, Delta<DgbFItem> patch)
        {
        ...
        public async Task<IActionResult> Post([FromBody]  DgbFItem dgbFItem)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public async Task<IActionResult> Patch([FromODataUri] Guid key, Delta<DgbFItem> patch)
        {
