...
namespace STOCMA.Controllers
{
    ...
    */
    public class DgbItemsController : ODataController
    {
        ...
        public async Task<IActionResult> Put([FromODataUri] Guid key, Delta<DgbItem> patch)
        {
        ...
        // POST: odata/DgbItems
        public async Task<IActionResult> Post([FromBody]  DgbItem dgbItem)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public async Task<IActionResult> Patch([FromODataUri] Guid key, Delta<DgbItem> patch)
        {
