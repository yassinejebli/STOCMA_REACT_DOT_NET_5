...
namespace STOCMA.Controllers
{
    ...
    */
    public class DgbsController : ODataController
    {
        ...
        // PUT: odata/Dgbs(5)
        public async Task<IActionResult> Put([FromODataUri] Guid key, Delta<Dgb> patch)
        {
        ...
        // POST: odata/Dgbs
        public async Task<IActionResult> Post([FromBody]  Dgb dgb)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public async Task<IActionResult> Patch([FromODataUri] Guid key, Delta<Dgb> patch)
        {
