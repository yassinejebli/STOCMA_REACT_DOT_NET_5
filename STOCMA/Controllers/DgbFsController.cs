...
namespace STOCMA.Controllers
{
    ...
    */
    public class DgbFsController : ODataController
    {
        ...
        // PUT: odata/DgbFs(5)
        public async Task<IActionResult> Put([FromODataUri] Guid key, Delta<DgbF> patch)
        {
        ...
        // POST: odata/DgbFs
        public async Task<IActionResult> Post([FromBody]  DgbF dgbF)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public async Task<IActionResult> Patch([FromODataUri] Guid key, Delta<DgbF> patch)
        {
