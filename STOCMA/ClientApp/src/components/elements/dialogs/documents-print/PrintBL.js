...
const PrintBL = ({ document, typePaiement, onClose, onExited, open }) => {
    ...
    const [isMiniDocument, setIsMiniDocument] = React.useState(document?.WithDiscount);
                ...
                {document &&
                    <>
                        <Box display="flex" justifyContent="space-between" flexWrap="wrap">
                            <FormControlLabel
                                control={<Switch
                                    checked={isMiniDocument}
                                    onChange={(_, checked) => setIsMiniDocument(checked)} />}
                                label="Grand format"
                            />
                            <FormControlLabel
                                control={<Switch
